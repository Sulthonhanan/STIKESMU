    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        @php
            $jalurList = [
                ...
                [
                    'id' => 'Jalur Beasiswa & Prestasi',
                    'nama' => 'Jalur Beasiswa & Prestasi',
                    'desc' => 'Seleksi khusus bagi penerima Beasiswa KIP-Kuliah, Tahfizh Qur\'an, Kader Muhammadiyah, serta Prestasi Akademik/Non-Akademik.',
